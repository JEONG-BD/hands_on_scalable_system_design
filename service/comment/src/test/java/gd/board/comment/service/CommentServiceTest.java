...
class CommentServiceTest {
    ...
    public void deleteShouldMarkDeletedHasChildren() {
        //given
        Long articleId = 1L;
        Long commentId = 2L;
    ...
    public void deleteShouldDeleteOnlyIFNotDeleteParent() {
        //given
        Long articleId = 1L;
        Long commentId = 2L;
    ...
    public void deleteShouldDeleteAllRecursivelyIfDeletedParent() {
        //given
        Long articleId = 1L;
        Long commentId = 2L;
        Long parentCommentId = 1L;
