...
public class CommentPath {
    ...
    public CommentPath createCommentPath(String descendantsTopPath){
        if(descendantsTopPath == null){
            return CommentPath.create(path + MIN_CHUNK);
        }
        String childrenTopPath = findChildrenPath(descendantsTopPath);
        return CommentPath.create(increase(path + MIN_CHUNK));
    }
    ...
    private String findChildrenPath(String descendantsTopPath) {
